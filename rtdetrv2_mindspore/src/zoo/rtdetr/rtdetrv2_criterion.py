...
# NOTE: torchvision.ops.sigmoid_focal_loss 在 MSAdapter/Ascend 上不稳定，改用纯 Python 实现
...
@register()
class RTDETRCriterionv2(nn.Cell):
    ...
    def _sigmoid_focal_loss(inputs, targets, alpha, gamma):
        """纯 Python 实现 sigmoid focal loss，替代 torchvision.ops.sigmoid_focal_loss
        (MSAdapter/Ascend 上 torchvision C++ 扩展不可用)
        """
    ...
    def loss_labels_focal(self, outputs, targets, indices, num_boxes):
        ...
        # 使用纯 Python 实现替代 torchvision.ops.sigmoid_focal_loss
    ...
    def loss_labels_vfl(self, outputs, targets, indices, num_boxes, values=None):
        ...
        pred_score = F.sigmoid(src_logits)
    ...
    def get_cdn_matched_indices(dn_meta, targets):
        ...
        for i, num_gt in enumerate(num_gts):
            if num_gt > 0:
                ...
                dn_match_indices.append((torch.zeros(0, dtype=mindspore.int64, device=device), \
