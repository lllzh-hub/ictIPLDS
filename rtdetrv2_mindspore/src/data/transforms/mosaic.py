...
# Soft base class for transforms in case mindspore.mintvision.transforms
# does not expose a proper Transform base.
...
class Mosaic(BaseTransform):
    ...
    def construct(self, *inputs):
        ...
        offset = mindspore.Tensor([[0, 0], [w, 0], [0, h], [w, h]]).repeat(1, 2)
        target = {}
        for k in targets[0]:
            if k == 'boxes':
