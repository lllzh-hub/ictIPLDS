...
try:
    from mindspore.mint.models.feature_extraction import get_graph_node_names, create_feature_extractor
except Exception:
    get_graph_node_names = None
