...
from .ms_init_compat import *
from .ms_init_compat import constant_, zeros_, ones_, normal_, xavier_uniform_, xavier_normal_, kaiming_uniform_, kaiming_normal_, uniform_
import src.nn.backbone.ms_init_compat as init
...
class LearnableAffineBlock(nn.Cell):
    def __init__(self, scale_value=1.0, bias_value=0.0):
        super().__init__()
        self.scale = nn.Parameter(mindspore.Tensor([scale_value]))
        self.bias = nn.Parameter(mindspore.Tensor([bias_value]))
